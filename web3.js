...
const web3 = new Web3(new Web3.providers.HttpProvider("https://"+ "ropsten" +".infura.io/"+keys["ropsten"].infura_api_key));
            ...
            web3.eth.getTransactionCount(keys[request_data.netType].cps_public_key).then(function(res){
                ...
                web3.eth.accounts.signTransaction(rawTx, keys[request_data.netType].cps_private_key).then(signed => {
                    ...
                    // console.log(receipt)
                     ...
                     createNewCustomer( request_data, address);
...
// var contractInstance1 = new web3.eth.Contract(abi, '0xC33F8fC87D6De4f76FEEa2f2e767d61CF9be6E73');
// console.log('here1')
// var data = contractInstance1.methods.createCustomer('hey',5).encodeABI();
// console.log('here2')
